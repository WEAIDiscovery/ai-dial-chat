...
export const Composable__ChatView = () => {
...
export const ChatView = memo(Inversify.register(Composable__ChatView));
ChatView.displayName = 'ChatView';

export function Composable__Chat() {
...
export const Chat = Inversify.register(Composable__Chat);
